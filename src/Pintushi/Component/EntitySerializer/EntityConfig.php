...
class EntityConfig
{
     ...
     * key "_" {@see \Pintushi\Component\EntitySerializer\ConfigUtil::INFO_RECORD_KEY}
     * and value ['has_more' => true] {@see \Pintushi\Component\EntitySerializer\ConfigUtil::HAS_MORE}
