...
{
    const COMPILER_PASS_NAME = 'pintushi_navigation';
    const CACHE_KEY = 'pintushi_navigation.configuration_data';
    ...
    private function getConfigurationLoader()
    {
        return new CumulativeConfigLoader(
            ...
            new YamlCumulativeFileLoader('Resources/config/app/navigation.yml')
        );
    }
}
