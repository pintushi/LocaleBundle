...
use Pintushi\Bundle\EntityConfigBundle\Exception\RuntimeException;
use Pintushi\Bundle\EntityConfigBundle\Tools\ConfigHelper as ToolConfigHelper;
...
class ConfigModelManager
{
     ...
     */
    public function __construct(EntityManager $entityManager, LockObject $lockObject, ConfigDatabaseChecker $databaseChecker)
    {
     ...
     *
     * @return EntityConfAigModel|null An instance of EntityConfigModel or null if a model was not found
     */
    ...
    public function changeFieldName($className, $fieldName, $newFieldName)
    {
        ...
        if ($fieldModel && $fieldModel->getFieldName() !== $newFieldName) {
            ...
            $this->entityManager->persist($fieldModel);
    ...
    public function clearCache()
    {
        ...
        $em->clear('Pintushi\Bundle\EntityConfigBundle\Entity\FieldConfigModel');
        $em->clear('Pintushi\Bundle\EntityConfigBundle\Entity\EntityConfigModel');
    }
    ...
    protected function loadEntityModels()
    {
        ...
        if (empty($alreadyLoadedIds)) {
            return $this->entityManager
                ->getRepository('Pintushi\Bundle\EntityConfigBundle\Entity\EntityConfigModel')
                ->findAll();
        } else {
            return $this->entityManager
                ->getRepository('Pintushi\Bundle\EntityConfigBundle\Entity\EntityConfigModel')
    ...
    {
        $entityState = $this->entityManager
            ->getUnitOfWork()
