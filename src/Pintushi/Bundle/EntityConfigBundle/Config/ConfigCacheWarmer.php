...
use Pintushi\Bundle\EntityBundle\Provider\VirtualFieldProviderInterface;
use Pintushi\Bundle\EntityBundle\Provider\VirtualRelationProviderInterface;
use Pintushi\Bundle\EntityConfigBundle\Entity\ConfigModel;
use Pintushi\Bundle\EntityExtendBundle\EntityConfig\ExtendScope;
...
class ConfigCacheWarmer
{
    ...
    protected function loadConfigurableEntities()
    {
        ...
        $entityRows = $connection
            ->executeQuery('SELECT id, class_name, mode, data FROM pintushi_entity_config');
    ...
    protected function loadConfigurableFields(array $classMap)
    {
        ...
        $fieldRows  = $connection
            ->executeQuery('SELECT id, entity_id, field_name, type, mode, data FROM pintushi_entity_config_field');
