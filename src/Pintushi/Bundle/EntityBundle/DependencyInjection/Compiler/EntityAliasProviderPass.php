...
{
    const LOADER_SERVICE          = EntityAliasLoader::class;
    const ALIAS_PROVIDER_TAG_NAME = 'pintushi_entity.alias_provider';
    const CLASS_PROVIDER_TAG_NAME = 'pintushi_entity.class_provider';
