...
namespace Pintushi\Bundle\FilterBundle\DependencyInjection\Compiler;
...
{
    const FILTER_EXTENSION_ID = 'pintushi_filter.extension.orm_filter';
    const TAG_NAME            = 'pintushi_filter.extension.orm_filter.filter';
