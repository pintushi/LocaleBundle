 ...
 * @package Pintushi\Bundle\GridBundle\DependencyInjection\CompilerPass
 */
class InlineEditColumnOptionsGuesserPass implements CompilerPassInterface
{
    const INLINE_EDIT_COLUMN_OPTIONS_GUESSER_SERVICE = 'pintushi_grid.datagrid.inline_edit_column_options_guesser';
    const TAG = 'pintushi_grid.inline_edit_column_options_guesser';
