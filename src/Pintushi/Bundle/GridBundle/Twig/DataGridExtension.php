...
namespace Pintushi\Bundle\GridBundle\Twig;

use Pintushi\Bundle\GridBundle\Datagrid\DatagridInterface;
use Pintushi\Bundle\GridBundle\Datagrid\Manager;
use Pintushi\Bundle\GridBundle\Datagrid\NameStrategyInterface;
use Pintushi\Bundle\GridBundle\Tools\DatagridRouteHelper;
...
{
    const ROUTE = 'pintushi_grid_index';
    ...
    {
        return $this->container->get('pintushi_grid.datagrid.manager');
    }
    ...
    {
        return $this->container->get('pintushi_grid.datagrid.name_strategy');
    }
    ...
    {
        return $this->container->get('pintushi_grid.helper.route');
    }
    ...
    {
        return [
            new \Twig_SimpleFunction('pintushi_grid_build', [$this, 'getGrid']),
            new \Twig_SimpleFunction('pintushi_grid_data', [$this, 'getGridData']),
            new \Twig_SimpleFunction('pintushi_grid_metadata', [$this, 'getGridMetadata']),
            new \Twig_SimpleFunction('pintushi_grid_generate_element_id', [$this, 'generateGridElementId']),
            new \Twig_SimpleFunction('pintushi_grid_build_fullname', [$this, 'buildGridFullName']),
            new \Twig_SimpleFunction('pintushi_grid_build_inputname', [$this, 'buildGridInputName']),
            new \Twig_SimpleFunction('pintushi_grid_link', [$this, 'generateGridUrl']),
            new \Twig_SimpleFunction('pintushi_grid_column_attributes', [$this, 'getColumnAttributes']),
            new \Twig_SimpleFunction('pintushi_grid_get_page_url', [$this, 'getPageUrl']),
        ];
    }
