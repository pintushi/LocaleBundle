 ...
 * @ORM\Entity()
 * @ORM\Table(
 *     name="pintushi_grid_view_user_rel",
 *     indexes={
 *         @ORM\Index(name="idx_pintushi_grid_view_user_rel_type", columns={"type"})
 *     }
 * )
 *
 * @ORM\InheritanceType("SINGLE_TABLE")
 * @ORM\DiscriminatorColumn(name="type", type="string")
 * @ORM\DiscriminatorMap({"grid_view_user" = "Pintushi\Bundle\GridBundle\Entity\GridViewUser"})
 */
