 ...
 * @ORM\Entity()
 * @ORM\Table(
 *     name="pintushi_grid_view",
 *     indexes={
 *         @ORM\Index(name="idx_pintushi_grid_view_discr_type", columns={"discr_type"})
 *     }
 * )
 *
 * @ORM\InheritanceType("SINGLE_TABLE")
 * @ORM\DiscriminatorColumn(name="discr_type", type="string")
 * @ORM\DiscriminatorMap({"grid_view" = "Pintushi\Bundle\GridBundle\Entity\GridView"})
 */
abstract class AbstractGridView implements ViewInterface
{
     ...
     * @ORM\Column(type="string")
     * @Assert\NotBlank
     * @Assert\Choice(callback={"Pintushi\Bundle\GridBundle\Entity\GridView", "getTypes"})
     */
     ...
     * @var Organization
     *
     * @ORM\ManyToOne(targetEntity="Pintushi\Bundle\OrganizationBundle\Entity\Organization")
