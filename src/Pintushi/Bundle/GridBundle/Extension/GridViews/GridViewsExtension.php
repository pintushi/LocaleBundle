...
use Pintushi\Bundle\GridBundle\Extension\Appearance\AppearanceExtension;
...
class GridViewsExtension extends AbstractExtension
{
    ...
    {
        return [
            'VIEW'   => $this->authorizationChecker->isGranted('pintushi_grid_gridview_view'),
            'CREATE' => $this->authorizationChecker->isGranted('pintushi_grid_gridview_create'),
            'EDIT'   => $this->authorizationChecker->isGranted('pintushi_grid_gridview_update'),
            'DELETE' => $this->authorizationChecker->isGranted('pintushi_grid_gridview_delete'),
            'SHARE'  => $this->authorizationChecker->isGranted('pintushi_grid_gridview_publish'),
        ];
    }
