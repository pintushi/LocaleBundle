define([
     ...
     * @class   pintushi.grid.action.DeleteMassAction
    ...
    DeleteMassAction = MassAction.extend({
        ...
        /** @property {Object} */
        confirmMessages: {
            selected_message: 'pintushi.grid.mass_action.delete.selected_message',
            max_limit_message: 'pintushi.grid.mass_action.delete.max_limit_message',
            restricted_access_message: 'pintushi.grid.mass_action.delete.restricted_access_message',
            restricted_access_empty_message: 'pintushi.grid.mass_action.delete.restricted_access_empty_message'
        },
