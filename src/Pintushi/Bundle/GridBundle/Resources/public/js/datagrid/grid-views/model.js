define([
    ...
    config = _.extend({
        route: 'pintushi_grid_api_rest_gridview_post'
    }, config);
    ...
    GridViewsModel = Backbone.Model.extend({
        ...
        /** @property */
        sharedByLabel: 'pintushi.grid.grid_views.shared_by.label',
        ...
        validate: function(attrs, options) {
            ...
            if (_.trim(attrs.label) === '') {
                errors.push(__('pintushi.grid.gridview.notBlank'));
            }

            if (_.trim(attrs.label) === _.trim(freezeName)) {
                errors.push(__('pintushi.grid.gridview.unique'));
            }
