define([
     ...
     * @class   pintushi.grid.action.ExportAction
    ...
    ExportAction = AbstractAction.extend({
        ...
        messages: {
            success: 'pintushi.grid.export.success.message',
            fail: 'pintushi.grid.export.fail.message'
        },
        ...
        initialize: function(options) {
            this.route = 'pintushi_grid_export_action';
            ...
            if (linkData.show_max_export_records_dialog &&
                ...
                $el.on('click', function(e) {
                    ...
                    self.confirmModal = (new self.confirmModalConstructor({
                        ...
                        content: __(
                            'pintushi.grid.export.max_limit_message',
