define(function(require) {
    ...
    GridViewsView = BaseView.extend({
        ...
        /** @property */
        defaultPrefix: __('pintushi.grid.gridView.all'),

        /** @property */
        route: 'pintushi_grid_api_rest_gridview_default',
        ...
        _onSaveModel: function(model) {
            ...
            model.save({
                ...
                success: function() {
                    self._showFlashMessage('success', __('pintushi.grid.gridView.updated'));
                }
            });
        },
        ...
        _onSaveAsModel: function(model) {
            ...
            model.save(null, {
                ...
                success: function(model) {
                    ...
                    self._updateTitle();
                    self._showFlashMessage('success', __('pintushi.grid.gridView.created'));
        ...
        onDelete: function(e) {
            ...
            confirm.on('ok', _.bind(function() {
                ...
                model.once('sync', function() {
                    this._showFlashMessage('success', __('pintushi.grid.gridView.deleted'));
        ...
        render: function(o) {
            ...
            html = this.template({
                ...
                editedLabel: __('pintushi.grid.gridView.data_edited'),
                actionsLabel: __('pintushi.grid.gridView.actions'),
                actions: actions,
        ...
        _getActions: function(GridView) {
            ...
            return [
                {
                    label: __('pintushi.grid.action.save_grid_view'),
                    name: 'save',
                ...
                {
                    label: __('pintushi.grid.action.save_grid_view_as'),
                    name: 'save_as',
                    enabled: this.permissions.CREATE
                },
                {
                    label: __('pintushi.grid.action.rename_grid_view'),
                    name: 'rename',
                    enabled: typeof GridView !== 'undefined' &&
                        GridView.get('editable')
                },
                {
                    label: __('pintushi.grid.action.share_grid_view'),
                    name: 'share',
                    enabled: typeof GridView !== 'undefined' &&
                ...
                {
                    label: __('pintushi.grid.action.unshare_grid_view'),
                    name: 'unshare',
                    enabled: typeof GridView !== 'undefined' &&
                            GridView.get('editable') &&
                ...
                {
                    label: __('pintushi.grid.action.discard_grid_view_changes'),
                    name: 'discard_changes',
                    enabled: this._getViewIsDirty(GridView)
                },
                {
                    label: __('pintushi.grid.action.delete_grid_view'),
                    name: 'delete',
                    enabled: typeof GridView !== 'undefined' &&
                        GridView.get('deletable')
                },
                {
                    label: __('pintushi.grid.action.set_as_default_grid_view'),
                    name: 'use_as_default',
                    enabled: typeof GridView !== 'undefined' &&
