define(function(require) {
    ...
    Grid = Backgrid.Grid.extend({
        ...
        /** @property {Object} */
        noDataTranslations: {
            entityHint: 'pintushi.grid.entityHint',
            noColumns: 'pintushi.grid.no.columns',
            noEntities: 'pintushi.grid.no.entities',
            noResults: 'pintushi.grid.no.results',
            noResultsTitle: 'pintushi.grid.no.results_title'
        },
        ...
        defaults: {
            ...
            actionOptions: {
                refreshAction: {
                    launcherOptions: {
                        label: __('pintushi_grid.action.refresh'),
                ...
                resetAction: {
                    launcherOptions: {
                        label: __('pintushi_grid.action.reset'),
         ...
         * @param {Array<pintushi.grid.action.AbstractAction>} [options.rowActions] Array of row actions prototypes
         * @param {Backbone.Collection<pintushi.grid.action.AbstractAction>} [options.massActions] Collection of mass actions prototypes
         * @param {Boolean} [options.multiSelectRowEnabled] Option for enabling multi select row
         * @param {pintushi.grid.action.AbstractAction} [options.rowClickAction] Prototype for
        ...
        _getToolbarActions: function() {
            ...
            if (this.toolbarOptions.addAppearanceSwitcher) {
                var action = new SelectDataAppearanceAction({
                    datagrid: this,
                    launcherOptions: {
                        label: __('pintushi_grid.action.appearance'),
         ...
         *
         * @return {pintushi.grid.action.RefreshCollectionAction}
         */
         ...
         *
         * @return {pintushi.grid.action.ResetCollectionAction}
         */
         ...
         *
         * @return {pintushi.grid.action.ExportAction}
         */
        getExportAction: function() {
            if (!this.exportAction) {
                ...
                this.exportAction = new ExportAction({
                    datagrid: this,
                    launcherOptions: {
                        label: __('pintushi.grid.extension.export.label'),
                        title: __('pintushi.grid.extension.export.tooltip'),
                        className: 'btn',
