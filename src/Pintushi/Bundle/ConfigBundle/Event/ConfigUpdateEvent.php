...
use Pintushi\Bundle\ConfigBundle\Config\ConfigChangeSet;
use Pintushi\Bundle\ConfigBundle\Exception\UnexpectedTypeException;
use Symfony\Component\EventDispatcher\Event;

class ConfigUpdateEvent extends Event
{
    const EVENT_NAME = 'pintushi_config.update_after';
    ...
    public function __construct($changeSet, $scope = null, $scopeId = null)
    {
        if ($changeSet instanceof ConfigChangeSet) {
            ...
            throw new UnexpectedTypeException(
                $changeSet,
                'Pintushi\Bundle\ConfigBundle\Config\ConfigChangeSet or array'
            );
        }
