...
{
    const CONFIG_BAG_SERVICE = 'pintushi_config.config_bag';
    const CONFIG_DEFINITION_BAG_SERVICE = 'pintushi_config.config_definition_bag';
    const CONFIG_PROVIDER_TAG_NAME = 'pintushi_config.configuration_provider';
    ...
    protected function registerManagers(ContainerBuilder $container, $managers)
    {
        ...
        foreach ($managerDefs as $scope => $managerDef) {
            ...
            $managerId = 'pintushi_config.' . $scope;
            $container
        ...
        $container->setAlias(self::MAIN_MANAGER_SERVICE_ID, 'pintushi_config.' . $mainScope);
    }
    ...
    protected function loadConfig(ContainerBuilder $container, ProcessorDecorator $processor)
    {
        ...
        $configLoader = new CumulativeConfigLoader(
            'pintushi_system_configuration',
            new YamlCumulativeFileLoader('Resources/config/app/system_configuration.yml')
        );
